...
echo_and_run cd "/home/prajval/end_to_end_learning/src/yujin_ocs/yocs_ar_pair_approach"
...
echo_and_run /usr/bin/env \
    ...
    "/home/prajval/end_to_end_learning/src/yujin_ocs/yocs_ar_pair_approach/setup.py" \
     \
    build --build-base "/home/prajval/end_to_end_learning/build/yujin_ocs/yocs_ar_pair_approach" \
    install \
    --root="${DESTDIR-/}" \
