...
echo_and_run cd "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS-master/rover_ml/behavior_cloning"
...
echo_and_run /usr/bin/env \
    ...
    "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS-master/rover_ml/behavior_cloning/setup.py" \
     \
    build --build-base "/home/prajval/end_to_end_learning/build/diy_driverless_car_ROS-master/rover_ml/behavior_cloning" \
    install \
    --root="${DESTDIR-/}" \
