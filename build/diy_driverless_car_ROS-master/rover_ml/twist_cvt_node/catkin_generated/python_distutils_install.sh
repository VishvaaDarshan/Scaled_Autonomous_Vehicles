...
echo_and_run cd "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS-master/rover_ml/twist_cvt_node"
...
echo_and_run /usr/bin/env \
    ...
    "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS-master/rover_ml/twist_cvt_node/setup.py" \
     \
    build --build-base "/home/prajval/end_to_end_learning/build/diy_driverless_car_ROS-master/rover_ml/twist_cvt_node" \
    install \
    --root="${DESTDIR-/}" \
