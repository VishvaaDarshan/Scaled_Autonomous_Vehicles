...
echo_and_run cd "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS-master/rover_cv/lane_detection"
...
echo_and_run /usr/bin/env \
    ...
    "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS-master/rover_cv/lane_detection/setup.py" \
     \
    build --build-base "/home/prajval/end_to_end_learning/build/diy_driverless_car_ROS-master/rover_cv/lane_detection" \
    install \
    --root="${DESTDIR-/}" \
