...
echo_and_run cd "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS/rbcar_twist2ack"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS/rbcar_twist2ack/setup.py" \
     \
    build --build-base "/home/prajval/end_to_end_learning/build/diy_driverless_car_ROS/rbcar_twist2ack" \
    install \
    --root="${DESTDIR-/}" \
