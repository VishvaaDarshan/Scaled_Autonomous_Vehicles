...
echo_and_run cd "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS/rover_webcam"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS/rover_webcam/setup.py" \
     \
    build --build-base "/home/prajval/end_to_end_learning/build/diy_driverless_car_ROS/rover_webcam" \
    install \
    --root="${DESTDIR-/}" \
