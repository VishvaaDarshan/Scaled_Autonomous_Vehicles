...
def main():
     ...
     parser.add_argument('-o', '--outdir', type=str, nargs='?', default='/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS-master/rover_ml/output',
         help='Output folder')
     parser.add_argument('-i', '--indir', type=str, nargs='?', default='/home/prajval/end_to_end_learning/src/diy_driverless_car_ROS-master/rover_ml/data',
